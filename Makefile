...
PROGRAMS = testGraph testMini7 testMini6 testPartieB
...
testPartieB: testPartieB.o graph.o viaMinimization.o generatePostScript.o $(OBJSA)
		$(LINK) testPartieB.o viaMinimization.o graph.o generatePostScript.o $(OBJSA)
